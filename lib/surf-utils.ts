...
export function windColor(type: string, intensity: string): string {
  // TERRAL sempre verde (bom para surf)
  if (type === "TERRAL") return "#10b981"
  // MARAL FRACO verde (aceitavel)
  if (type === "MARAL" && intensity === "FRACO") return "#10b981"
  // MARAL MODERADO ou FORTE vermelho (ruim para surf)
